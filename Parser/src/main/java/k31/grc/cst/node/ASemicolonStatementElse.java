...
public final class ASemicolonStatementElse extends PStatementElse
{
    private PSemicolonStmt _semicolonStmt_;

    public ASemicolonStatementElse()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASemicolonStatementElse(
    ...
    {
        ((Analysis) sw).caseASemicolonStatementElse(this);
    }
