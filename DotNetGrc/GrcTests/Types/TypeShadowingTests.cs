...
{
	[TestFixture]
	public class TypeShadowingTests : TypeVisitorTests
	{
		[Test]
...
";
			Assert.Throws<FunctionAlreadyInScopeException>(() => AcceptTypeVisitor(program));
		}
...
";
			Assert.Throws<VariableAlreadyInScopeException>(() => AcceptTypeVisitor(program));
		}
